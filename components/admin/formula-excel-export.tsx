...
const FORMULA_FIELDS = [
  ...
  { key: "nds_tax", letter: "O", title: "НДС", formula: "O = P * 12 / (12 + 100)" },
  { key: "manager_bonus_unit", letter: "S", title: "Бонус менеджера за ед.", formula: "S = N * (R / 100)" },
  { key: "income_pre_kpn", letter: "T", title: "Доход без КПН", formula: "T = P - S - K - O" },
  ...
  { key: "total_selling_vat", letter: "X", title: "Общая сумма продажи с НДС", formula: "X = D * P" },
