...
const FORMULA_FIELDS: Array<{ key: keyof CustomFormulas; letter: string; title: string; placeholder: string }> = [
  { key: "delivery_per_unit", letter: "F", title: "Доставка за единицу", placeholder: "F = H / D" },
  { key: "sum_with_delivery", letter: "G", title: "Сумма за ед. с доставкой", placeholder: "G = E + F" },
  { key: "financial_load", letter: "J", title: "Финансовая нагрузка", placeholder: "J = G * (I / 100)" },
  { key: "sum_with_load", letter: "K", title: "Сумма с нагрузкой", placeholder: "K = G + J" },
  { key: "markup", letter: "M", title: "Накрутка", placeholder: "M = P - K" },
  { key: "markup_percent", letter: "L", title: "% накрутки", placeholder: "L = (M / K) * 100" },
  { key: "selling_price_no_vat", letter: "N", title: "Цена без НДС", placeholder: "N = P - O" },
  { key: "nds_tax", letter: "O", title: "НДС", placeholder: "O = N * (НДС / 100)" },
  { key: "manager_bonus_unit", letter: "S", title: "Бонус менеджера за ед.", placeholder: "S = N * (R / 100)" },
  { key: "income_pre_kpn", letter: "T", title: "Доход без КПН", placeholder: "T = P - E - F - J - S - O" },
