  ...
  const generateTemplate = async () => {
    ...
    try {
      ...
      const formulasData = [
        ...
        ["X", "Общая сумма продажи с НДС", "X = D * P", "X = D * P", "Общая сумма продажи с НДС"],
      ...
      const exampleData = [
        ...
        ["Общая сумма продажи с НДС", "X", "=D3*P3", "Общая сумма продажи с НДС", "=X3"],
